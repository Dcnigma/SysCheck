...
void drawLine(SDL_Renderer* main_renderer, int x, int y, int w, int h, Uint8 r, Uint8 g, Uint8 b, Uint8 a) { //funtion to draw a line x, y, w, h, with a rgb color of red, green, blue, alpha

	SDL_SetRenderDrawColor(main_renderer, r, g, b, a); //set the render color to r,g,b,a
	SDL_RenderDrawLine(main_renderer, x, y, w, h); //draw the line
	SDL_SetRenderDrawColor(main_renderer, 0, 0, 0, 0); //set the render color back to transparent

}
void Field()
{
  //Looks not good almost there...
                         //int x, int y, int w, int h, Uint8 r, Uint8 g, Uint8 b, Uint8 a
//drawLine(main_renderer, 170, 606, 5, 387 ,200, 200, 200, 0); // First line Vetical
//drawLine(main_renderer, 170, 606, 387, 5 ,200, 200, 200, 0);
//drawLine(main_renderer, 170, 37, 5, 387 ,200, 200, 200, 0); // First line horizon
//drawLine(main_renderer, 170, 37, 387, 5 ,200, 200, 200, 0); // First line Vetical
}
void loadFonts()
{
...
//dont forget SDL.h
    imageLoad(&menu1,     "romfs:/Menu1.png");
    imageLoad(&menu2,     "romfs:/Menu2.png");
    imageLoad(&menu3,     "romfs:/Menu3.png");
    imageLoad(&menu4,     "romfs:/Menu4.png");
    imageLoad(&menu5,     "romfs:/Menu5.png");
//Splash Screen
    imageLoad(&splash_icon, "romfs:/Splash_icon.png");
    imageLoad(&error_icon,      "romfs:/error_icon.png");
    imageLoad(&Ledoff,     "romfs:/redled.png");
    imageLoad(&Ledon,     "romfs:/greenled.png");
}
...
void sdlInit()
{
    ...
    main_window = SDL_CreateWindow("Dcnigma", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_W, SCREEN_H, SDL_WINDOW_SHOWN);
